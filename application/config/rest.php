...
|
*/
$config['rest_message_field_name'] = 'tips';
/*
|--------------------------------------------------------------------------
...
|
*/
$config['allowed_cors_origins'] = ['https://jt-api.nle-tech.com','http://localhost:8080','http://localhost:8081','https://dev-jt-das-api.nle-tech.com'];